...
This repository contains the conceptual definition and theoretical framework for **Sendet Message**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── sendet-message.tex    # LaTeX dissertation
├── whitepaper/
│   └── sendet-message.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025sendetmessage,
  author = {Vega, Adam Eren},
  title = {Sendet Message: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/sendet-message}
}
```
